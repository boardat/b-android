...
public class OauthLoginAccess  extends Request<OauthResponse> {
    ...
    public OauthLoginAccess(int method, String url, Response.ErrorListener errorListener, OnLoginListener listener, String oauthToken, String oauthSecret) {
    ...
    protected void deliverResponse(OauthResponse response) {
        if (response!=null && mOnLoginListener!=null) {
            ...
            mOnLoginListener.onAccessReceived(response);
        }
    }
